...
* @param[in] pawr_param @refer wiced_ble_padv_sync_established_event_data_t
* @return void
**************************************************************************************************/
void app_pawr_conn_up_cb(const wiced_ble_padv_sync_established_event_data_t *pawr_param)
{
